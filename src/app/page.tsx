    ...
    <main className="flex-1">
      ...
      <header className="border-b border-[var(--color-rule)]">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <span className="mono font-bold tracking-[0.18em] uppercase text-sm">
            ◈ Proof of Real
          </span>
          <span className="eyebrow hidden sm:block">Media Authenticity Registry</span>
        </div>
      </header>
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-12 text-center">
        ...
        <p className="text-[var(--color-ink-soft)] text-lg mt-6 max-w-2xl mx-auto">
          In an era of synthetic media, &ldquo;is this real?&rdquo; needs an answer you can check.
          Proof of Real is a public registry where creators seal originals and anyone can verify a
          file against them.
        </p>
      </section>
